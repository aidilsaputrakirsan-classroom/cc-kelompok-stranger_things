...
function DashboardBidan({ user, onLogout, onNavigate }) {
      ...
      <div style={styles.navbar}>
        ...
        <div style={styles.navMenu}>
          ...
          <button
            ...
            onClick={() => onNavigate?.("detailImunisasi")}
          >
            Detail Imunisasi
          </button>
      ...
      <div style={styles.main}>
        ...
        <div style={styles.left}>
            ...
            <p style={styles.reminderText}>
              {loading ? (
                ...
                <>
                  ...
                  untuk {upcomingSchedules[0].childName}
                </>
              ) : (
          ...
          <div>
            ...
            <div style={styles.statsGrid}>
              ...
              >
                <div style={styles.statLabel}>Total Anak</div>
              ...
              >
                ...
                <div style={styles.statSub}>Sudah lengkap</div>
              </div>
              <div
                style={{
                  ...styles.statCard,
              ...
              >
                ...
                <div style={styles.statSub}>Dalam 30 hari</div>
              </div>
              <div
                style={{
                  ...styles.statCard,
                ...
                upcomingSchedules.map((item) => (
                  ...
                  >
                    <div
                      style={{
                        ...styles.dot,
                        background: dotColors[item.dotStatus],
                      }}
                    />
                    <div style={{ flex: 1 }}>
        ...
        <div style={styles.right}>
          <div style={styles.infoCard}>
            <h3 style={styles.infoTitle}>Tips Hari Ini</h3>
          ...
          <div style={styles.infoCard}>
            <h3 style={styles.infoTitle}>Reminder Faskes</h3>
            <p style={styles.infoText}>
              Jangan lupa cek stok vaksin mingguan dan jadwal
              kunjungan posyandu.
            </p>
          </div>
          <div style={styles.infoCard}>
            ...
            <p style={styles.infoText}>
              Data imunisasi yang ditampilkan berasal dari
              seluruh pasien yang terdaftar pada sistem Bye
              Bye Virus.
            </p>
          </div>
        </div>
...
const styles = {
  ...
  reminderText: { margin: 0, fontSize: "14px", flex: 1 },
  reminderBadge: {
    background: "#c2185b",
    color: "white",
    borderRadius: "20px",
  ...
  statSub: { marginTop: "8px", fontSize: "12px", opacity: 0.9 },
  scheduleGrid: {
    display: "grid",
  ...
  schedDate: { fontSize: "12px", color: "#888", marginTop: "3px" },
  childName: { fontSize: "11px", color: "#999", marginTop: "4px" },
  schedBadge: {
    background: "#fce4ec",
    color: "#c2185b",
    padding: "5px 10px",
  ...
  infoText: { fontSize: "13px", lineHeight: 1.6, color: "#666" },
};
